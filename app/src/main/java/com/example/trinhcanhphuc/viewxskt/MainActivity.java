    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listTDXS.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Bundle b = new Bundle();
                b.putString("TongDai", tongDaiList[position]);
                b.putSerializable("Info", tongDais.get(position));
    ...
    private class GetKQSX extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... arg0) {
            ...
            if (jsonStr != null) {
                try {
                    ...
                    tongDaiList = new String[jsonObj.length()];
        ...
        protected void onPostExecute(Void result) {
            ...
            adapter = new ArrayAdapter(getApplicationContext(),
                    android.R.layout.simple_list_item_1, tongDaiList);
            listTDXS.setAdapter(adapter);
            listTDXS.setBackgroundColor(Color.BLUE);
